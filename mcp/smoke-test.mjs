...
try {
  ...
  const expectedTools = ['status', 'list_projects', 'get_block', 'list_attachments', 'read_attachment', 'search', 'create_block', 'move_block', 'create_work_item', 'create_task_block', 'update_task_block', 'convert_block_to_task', 'list_todos', 'add_todo', 'set_todo_status', 'get_or_create_daily_plan'];
