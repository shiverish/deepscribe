...
try {
  ...
  const expectedTools = ['status', 'list_projects', 'get_block', 'create_task', 'list_tasks', 'get_task', 'update_task_status', 'list_attachments', 'read_attachment', 'upload_attachment', 'search', 'get_context', 'create_block', 'move_block', 'list_claimable_work_items', 'claim_next_work_item', 'claim_work_item', 'renew_work_item_claim', 'transition_work_item', 'list_todos'];
